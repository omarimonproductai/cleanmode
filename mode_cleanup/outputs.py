...
<div class="controls">
  ...
  <select id="dead">
    <option value="">With and without "from definition"</option>
    <option value="si">Only with "from definition"</option>
    <option value="no">Only without "from definition"</option>
  </select>
  <select id="ageop">
